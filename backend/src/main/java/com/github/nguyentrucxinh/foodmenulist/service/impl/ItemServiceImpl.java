...
import com.github.nguyentrucxinh.foodmenulist.domain.BlobId;
...
//        );
        ...
        item.setBlobId(BlobId.builder().bucket(blob.getBlobId().getBucket()).name(blob.getBlobId().getName()).generation(blob.getBlobId().getGeneration()).build());
