...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers(HttpMethod.GET, SecurityConstants.CONFIRM_MAIL_SIGN_UP_URL).permitAll()
                .antMatchers(SecurityConstants.API_USER_URL + "/**").hasRole("USER")
                .antMatchers(SecurityConstants.API_ADMIN_URL + "/**").hasRole("ADMIN")
